...
public class Constants {
    ...
    public static final class Appwrite {
        ...
        public static final String SURVEY_RESPONSES_STUDYSESSIONS_ID = "683d8b18001052430bf4";
        public static final String SURVEY_RESPONSES_SCHEDULE_ID = "68442203003c48ed85ee";
        public static final String SURVEY_RESPONSES_SESSION_ID = "6845befe002bbc1fdca2";
        public static final String SURVEY_RESPONSES_WEEKLY_PLAN_ID = "6846523c000e3e1bf949"; // now
        public static final String SURVEY_RESPONSES_ACTIVITIES_ID = "6846537f001264ab943d";
        public static final String SURVEY_RESPONSES__MILESTONES_ID = "6846543500114458341e";
    }
